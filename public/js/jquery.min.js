/*! jQuery v2.1.3 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function(
	a,
	b
) {
				...
				return g !== n && g.nodeType === 9 && g.documentElement
					? ((n = g),
					  ...
					  (d.find.TAG = c.getElementsByTagName
							? function(a, b) {
									return typeof b.getElementsByTagName !==
										"undefined"
			...
			data(a, b) {
				...
				if (void 0 === a) {
					if (
						this.length &&
						((e = M.get(f)),
						f.nodeType === 1 && !L.get(f, "hasDataAttrs"))
					) {
						c = g.length;
						while (c--)
							g[c] &&
	...
	let Q = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		R = ["Top", "Right", "Bottom", "Left"],
		S = function(a, b) {
			return (
				(a = b || a),
				n.css(a, "display") === "none" ||
					!n.contains(a.ownerDocument, a)
			);
		},
		T = /^(?:checkbox|radio)$/i;
	!(function() {
		let a = l.createDocumentFragment(),
		...
		trigger(b, c, d, e) {
			...
			if (
				...
				d.nodeType !== 3 &&
					...
					(b = b[n.expando]
						? b
						: new n.Event(q, typeof b === "object" && b)),
					(b.isTrigger = e ? 2 : 3),
					(b.namespace = r.join(".")),
	...
	let ab = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
		bb = /<([\w:]+)/,
		cb = /<|&#?\w+;/,
	...
	function Ib(a, b, c) {
		let d = !0,
			...
			f = wb(a),
			g = n.css(a, "boxSizing", !1, f) === "border-box";
		if (e <= 0 || e == null) {
			if (
				((e = xb(a, b, f)),
			...
			_default: {
				...
				set(a) {
					n.fx.step[a.prop]
						? n.fx.step[a.prop](a)
						: a.elem.style &&
						  (a.elem.style[n.cssProps[a.prop]] != null ||
								n.cssHooks[a.prop])
	...
	(n.fn.load = function(a, b, c) {
		if (typeof a !== "string" && Hc) return Hc.apply(this, arguments);
		let d,
			e,
			f,
			g = this,
	...
	const Ic = a.document.documentElement;
