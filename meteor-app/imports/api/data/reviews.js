...
const ReviewSchema = yup.object().shape({
	...
	// QUESTION: should submittedBy be required, or do we trust
	// that it's always automatically set? Users currently
	// must have accounts in order to submit reviews...
	submittedBy: yup.number().integer().notRequired(),
	companyName: yup.string().max(100).required(), // BUG needs replacement custom validator
