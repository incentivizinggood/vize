...
export const JobPostTitleRow = function (props: JobPostInterface): JSX.Element {
	return <JobPostTitle>
		<JobPostHeaderRightSection>
			...
			<PostHeaderContent>
				...
				<RatingWrapper>
					...
					}} numReviews={props.reviewCount} companyName="" />
					<ReviewCount>{props.reviewCount} Reviews</ReviewCount>
				</RatingWrapper>
			</PostHeaderContent>
		</JobPostHeaderRightSection>
		{props.modal ? <JobPostHeaderLeftSection>
			<ActionsWrapper>
				<Button >
					<ReplyIconWrapper>
						<ReplyIcon />
		...
		</JobPostHeaderLeftSection> : null}
	</JobPostTitle>

}
export const JobContentWrapper = function (props: JobPostInterface): JSX.Element {
	return <>
		<JobBasicDetails>
			<JobDetailsWrapper>
