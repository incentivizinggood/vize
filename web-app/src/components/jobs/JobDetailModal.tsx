...
import { JobPostTitleRow, JobContentWrapper } from "src/pages/for-employers/JobPost";
...
export default function JobDetailModal(props: JobDetailModalProps): JSX.Element {
    ...
    >
        <JobPostContent>
            <JobPostTitleRow {...jobPost} modal onClose={onClose}></JobPostTitleRow>
            <Tabs
                value={activetTab}
                ...
                <CompanyContent>
                    ...
                    <JobCompanyBasicDetail>
                        ...
                        <Row>
                            ...
                            <Col>
                                {jobPost.companyDetail.industry}
                            </Col>
                        </Row>
                        <Row>
                            <Col md={3}>
                        ...
                        <Row>
                                    ...
                                    <ListGroup>
                                        ...
                                        <ListGroup.Item>
                                            <RatingContainer>
                                                ...
                                                <div>
                                                    <StarRatings
                                                        rating={jobPost.companyDetail.ratings.overallSatisfaction}
                                                        starDimension="15px"
                                                        starSpacing="1.5px"
                                                    />
                                                </div>
                                        ...
                                        <ListGroup.Item>
                                            <RatingContainer>
                                                ...
                                                <div>
                                                    <StarRatings
                                                        rating={jobPost.companyDetail.ratings.healthAndSafeety}
                                                        starDimension="15px"
                                                        starSpacing="1.5px"
                                                    />
                                                </div>
                                        ...
                                        <ListGroup.Item>
                                            <RatingContainer>
                                                ...
                                                <div>
                                                    <StarRatings
                                                        rating={jobPost.companyDetail.ratings.workEnvironment}
                                                        starDimension="15px"
                                                        starSpacing="1.5px"
                                                    />
                                                </div>
                                        ...
                                        <ListGroup.Item>
                                            <RatingContainer>
                                                ...
                                                <div>
                                                    <StarRatings
                                                        rating={jobPost.companyDetail.ratings.managerRelationships}
                                                        starDimension="15px"
                                                        starSpacing="1.5px"
                                                    />
                                                </div>
                                        ...
                                        <ListGroup.Item>
                                            <RatingContainer>
                                                ...
                                                <div>
                                                    <StarRatings
                                                        rating={jobPost.companyDetail.ratings.benefits}
                                                        starDimension="15px"
                                                        starSpacing="1.5px"
                                                    />
                                                </div>
                            ...
                            <Column md={6}>
                                <StatesWrapper>
                                    <Stats>
                                        <div>
                                            <StatesTitle>{jobPost.companyDetail.recommendationPercenteage}%</StatesTitle>
                                            <span>The percentage of reviewers that would recommend {jobPost.company} to a friend</span>
                                        </div>
                                    </Stats>
                                    <Stats>
                                        <div>
                                            <StatesTitle>{jobPost.companyDetail.averageStay}</StatesTitle>
                                            The average numbe of months that workeer stays at the factory
                                        </div>
                                    </Stats>
                                </StatesWrapper>
                            </Column>
                    ...
                    <CommpanyReviewsWrapper>
                        ...
                        {jobPost.companyDetail.salaries.map((v: any, index: number) => {
                            return <ReviewDetails key={index}>
                                ...
                                <AveeragePay>
                                    <GreyText>Average</GreyText> <span>:  $ {v.pay} / week</span>
                                </AveeragePay>
