...
Meteor.startup(async () => {
	...
	if (Meteor.isServer) {
		...
		Meteor.methods({
			"postgres-companies.createProfile"(_newCompanyProfile) {
				...
				if (!validationResult) {
					throw new Meteor.Error(
						...
						i18n.__(
							"common.methods.errorMessages.invalidFormInputs"
						),
						errors
					);
				}
				...
				console.log("Successfully invoked method with PostgreSQL!");
