...
INSERT INTO salaries(submittedBy,companyName,jobTitle,
	...
	VALUES(NULL,'a','a','Hourly Wage',0);
\! echo "INVALID ARG TEST 2: NULL fields, part 2"
INSERT INTO salaries(submittedBy,companyName,jobTitle,
					incomeType,incomeAmount)
	VALUES(0,NULL,'a','Hourly Wage',0);
\! echo "INVALID ARG TEST 3: NULL fields, part 3"
INSERT INTO salaries(submittedBy,companyName,jobTitle,
					incomeType,incomeAmount)
	VALUES(0,'a',NULL,'Hourly Wage',0);
...
INSERT INTO salaries(submittedBy,companyName,jobTitle,
					incomeType,incomeAmount)
	VALUES(0,'a','a','Hourly Wage',NULL);
\! echo "INVALID ARG TEST 6: negative income"
INSERT INTO salaries(submittedBy,companyName,jobTitle,
					incomeType,incomeAmount)
	VALUES(0,'a','a','Hourly Wage',-.001);
\! echo "INVALID ARG TEST 7: invalid income type 1"
INSERT INTO salaries(submittedBy,companyName,jobTitle,
					incomeType,incomeAmount)
	VALUES(0,'a','a','Yearly Salar',0);
\! echo "INVALID ARG TEST 8: invalid income type 2"
INSERT INTO salaries(submittedBy,companyName,jobTitle,
					incomeType,incomeAmount)
	VALUES(0,'a','a','Monly Salary',0);
\! echo "INVALID ARG TEST 9: invalid income type 3"
INSERT INTO salaries(submittedBy,companyName,jobTitle,
					incomeType,incomeAmount)
	VALUES(0,'a','a','Hourly Wags',0);
\! echo "INVALID ARG TEST 10: duplicate salaryid"
INSERT INTO salaries(salaryId,submittedBy,companyName,jobTitle,
					incomeType,incomeAmount)
	VALUES(1,0,'a','a','Hourly Wage',0);
